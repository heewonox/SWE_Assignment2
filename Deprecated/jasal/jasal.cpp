		...
		switch(menu_level_1){
			...
			case 2:
			{
				switch(menu_level_2){
					...
					{
						//Log in
						CURRENT_SESSION_ID=login.setCurrentSessionID();
						break;
					}
					case 2:
					{
						//Log out
						if(logout.isLogOutSuccessful(CURRENT_SESSION_ID)){
			...
			case 4:
			{
				switch(menu_level_2){
					...
					{
						//Rent bike
						rentbicycle.job(CURRENT_SESSION_ID,&rentalstatus,&bicyclelist);
						break;
					}
				}
				break;
			...
			case 5:
			{
				switch(menu_level_2){
					...
					{
						//Show Rental info
						showrentalinfo.job(CURRENT_SESSION_ID);
						break;
					}
				}
				break;
